...
const params = {
  ...
  globalClusterInstanceHostPatterns:
    "?.XYZ1.us-east-1.rds.amazonaws.com,?.XYZ2.us-east-2.rds.amazonaws.com,?.XYZ3.us-west-2.rds.amazonaws.com",
...
const params = {
  ...
  globalClusterInstanceHostPatterns:
    "?.XYZ1.us-east-1.rds.amazonaws.com,?.XYZ2.eu-west-1.rds.amazonaws.com,?.XYZ3.ap-southeast-1.rds.amazonaws.com",
