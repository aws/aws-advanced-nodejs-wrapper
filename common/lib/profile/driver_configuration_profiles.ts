  ...
  private static readonly presets: Map<string, ConfigurationProfile> = new Map<string, ConfigurationProfile>([
    ...
    [
      ...
      new ConfigurationProfile(
        ConfigurationProfilePresetCodes.SF_D0,
        // Factories should be presorted by weights!
        [AuroraInitialConnectionStrategyFactory, AuroraConnectionTrackerPluginFactory, FailoverPluginFactory],
        new Map<string, any>([
          //[WrapperProperties.CONNECT_TIMEOUT.name, 10000],
          //[WrapperProperties.SOCKET_TIMEOUT.name, 5000],
          //[WrapperProperties.LOGIN_TIMEOUT.name, 10000],
    ...
    [
      ...
      new ConfigurationProfile(
        ConfigurationProfilePresetCodes.SF_F0,
        // Factories should be presorted by weights!
        [AuroraInitialConnectionStrategyFactory, AuroraConnectionTrackerPluginFactory, FailoverPluginFactory, HostMonitoringPluginFactory],
        new Map<string, any>([
          [WrapperProperties.FAILURE_DETECTION_TIME_MS.name, 60000],
          [WrapperProperties.FAILURE_DETECTION_COUNT.name, 5],
          [WrapperProperties.FAILURE_DETECTION_INTERVAL_MS.name, 15000]
